...
import 'package:movietix_distributor/presentation/screens/upcoming/imageupcoming.dart';
import 'package:movietix_distributor/presentation/screens/upcoming/upcomingdropdown.dart';
import 'package:movietix_distributor/presentation/widgets/textformfield.dart';
import 'package:provider/provider.dart';
import 'dart:io';


class AddingUpcoming extends StatelessWidget {
  const AddingUpcoming({Key? key}) : super(key: key);
                      ...
                      children: [
                        Center(
                          child: GestureDetector(
                            onTap: () => pickImageupcoming(context),
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () => showAddCastDialogupcoming(context),
                              child: Column(
                                children: [
                                  Container(
                                    height: 50,
