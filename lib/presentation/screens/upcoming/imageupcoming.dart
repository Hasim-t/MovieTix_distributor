...
Future<void> showAddCastDialogupcoming(BuildContext context) async {
  String actorName = '';
  String castName = '';
  File? castImage;
  String? imageError;
              ...
              TextButton(
                ...
                onPressed: () {
                  if (actorName.isNotEmpty && castName.isNotEmpty && castImage != null) {
                    Provider.of<UpcomingProvider>(context, listen: false).addCast({
                      'actorName': actorName,
                      'castName': castName,
...
Future<String> convertHeicToJpeg(String heicPath) async {
 ...
 Future<void> pickImageupcoming(BuildContext context) async {
    final ImagePicker picker = ImagePicker();
    final movieProvider = Provider.of<UpcomingProvider>(context, listen: false);
